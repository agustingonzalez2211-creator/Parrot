...
export interface SkillOutput {
  skill_name: string;                    // kebab-case, no extension
  skill_filename: string;                // e.g. exportar-reporte-mensual.md
  skill_content: string;                 // full .md content: markdown title + YAML block
